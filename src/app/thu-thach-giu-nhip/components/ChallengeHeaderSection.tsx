...
export function ChallengeHeaderSection() {
  return (
    ...
    >
      <h1 className="font-prata text-tiger-blue-600 leading-tight px-6 sm:px-8 md:px-0 text-4xl sm:text-5xl lg:text-6xl">
      ...
      <div className="px-6 sm:px-8 md:px-0">
        ...
        <p className="text-[16px] text-gray-700 leading-relaxed max-w-4xl mx-auto font-noto-sans text-left md:text-center" style={{ marginTop: 0 }}>
      ...
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-prata px-6 sm:px-8 md:px-0" style={{ marginTop: '48px' }}>
